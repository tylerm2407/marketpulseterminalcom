...
Keep it factual, concise, and under 300 words. Use bullet points. Do NOT give investment advice.`;
          ...
          messages: [
            {
              role: "system",
              content:
                "You are a financial markets analyst who summarizes the latest news, tweets, and social media buzz for stocks. Be concise, factual, and neutral.",
            },
    ...
    return new Response(JSON.stringify({ content, generatedAt: new Date().toISOString() }), {
      headers: { ...corsHeaders, "Content-Type": "application/json" },
    });
  } catch (e) {
